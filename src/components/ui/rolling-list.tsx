...
function RollingTextItem({ item }: RollingTextItemProps) {
    return (
        <div className="group relative w-full cursor-pointer border-b border-black/10 py-6">
            {/* Rolling text */}
            <div className="relative overflow-hidden h-[60px] md:h-20">
                <div className="transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:-translate-y-1/2">
                    ...
                    <div className="h-[60px] md:h-20 flex items-center">
                        <h2 className="text-5xl md:text-7xl font-normal text-neutral-900 uppercase tracking-tighter">
                            {item.title}
                        </h2>
                    </div>
                    ...
                    <div className="h-[60px] md:h-20 flex items-center">
                        <h2
                            className={cn(
                                "text-5xl md:text-7xl font-normal uppercase tracking-tighter italic",
...
function RollingTextList() {
    ...
    return (
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center justify-center px-4 py-12">
